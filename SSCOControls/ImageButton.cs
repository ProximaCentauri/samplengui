...
namespace SSCOControls
{
    public class ImageButton : Button, ISupportUserInput
    {
        ...
        public static DependencyProperty PreferredFontSizeProperty = DependencyProperty.Register("PreferredFontSize", typeof(double), typeof(ImageButton), new PropertyMetadata(Double.NaN, OnPreferredFontSizeChanged));
        public static DependencyProperty MinimumFontSizeProperty = DependencyProperty.Register("MinimumFontSize", typeof(double), typeof(ImageButton), new PropertyMetadata(Double.NaN, OnMinimumFontSizeChanged));
