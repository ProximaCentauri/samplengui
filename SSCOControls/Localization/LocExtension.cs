        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            if (service.TargetObject is DependencyObject)
            {
                ...
                if (property.IsInDesignMode)
                {
                    ...
                    ((DependencyObject)service.TargetObject).Dispatcher.BeginInvoke(new SendOrPostCallback(x => ((LocalizedValue)x).UpdateValue()),
                        DispatcherPriority.ApplicationIdle, localizedValue);
                }
