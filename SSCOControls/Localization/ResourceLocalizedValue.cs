...
namespace SSCOControls
{
    ...
    public class ResourceLocalizedValue : LocalizedValue
    {
        ...
        protected override object GetLocalizedValue()
        {
            ...
            bool primaryLanguage = null != LocalizationManager.LanguageCallback ?
                LocalizationManager.LanguageCallback(Property.Object as DependencyObject) : true;
            CultureInfo uiCulture = primaryLanguage ? Property.GetUICulture() : LocalizationManager.SecondaryCultureInfo;
            var value = resourceManager.GetObject(this.resourceKey, uiCulture);
            if (value == null)
            {
                return GetFallbackValue();
            }
