...
namespace SSCOControls
{
    ...
    public static class LocalizationManager
    {
        ...
        public static CultureInfo SecondaryCultureInfo
        { 
            get
            {
                return secondaryCultureInfo;
            }  
            set
            {
                secondaryCultureInfo = value;
            }
        }
        ...
        /// </summary>
        private static Dictionary<LocalizedProperty, LocalizedValue> _localizedValues = new Dictionary<LocalizedProperty, LocalizedValue>();

        /// <summary>
        /// The number of localized values added after the last purge.
        /// </summary>
        private static int _localizedValuesPurgeCount;
        
        private static List<ResourceManagerData> _resourceManagers = new List<ResourceManagerData>();        
        private static object _defaultResourceManagerSyncRoot = new object();
        private static ResourceManager _defaultResourceManager;
        private static bool _defaultResourceManagerSet;     
        private static CultureInfo secondaryCultureInfo = new CultureInfo("en-US");
    }
}
