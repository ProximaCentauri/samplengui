...
namespace SSCOControls
{
    ...
    public class PreviewTextBox : TextBox
    {
        ...
        /// </summary>
        public static readonly RoutedEvent PreviewTextChangedEvent = EventManager.RegisterRoutedEvent("PreviewTextChanged", RoutingStrategy.Tunnel,
        ...
        public event PreviewTextChangedEventHandler PreviewTextChanged
        {
            add
            { 
                AddHandler(PreviewTextChangedEvent, value);
            }
            remove
            { 
                RemoveHandler(PreviewTextChangedEvent, value);
            }
        }
        #endregion // Events
        ...
        private void previewExecutedEvent(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (e.Command == ApplicationCommands.Paste)
            {
                ...
                textInput(e, (string)Clipboard.GetDataObject().GetData(typeof(string)));
                // Return to caller
                return;
            } // If this is a paste command...
        ...
        private void textInput(RoutedEventArgs e, string text)
        {
            // Get the start of the selection (caret position) and length of selection
            int start = SelectionStart;
            int length = SelectionLength;
